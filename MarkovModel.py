...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        cost += 0.5 * self._param.get_annual_treatment_cost(current_state) * self._param.get_delta_t() + 0.5 * self._param.get_annual_treatment_cost(next_state) * self._param.get_delta_t()
